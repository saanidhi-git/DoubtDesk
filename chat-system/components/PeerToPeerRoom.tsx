...
export default function PeerToPeerRoom() {
  const [room] = useState('peer-to-peer');
  return (
        ...
        <header className="mb-6 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-right">
              <h1 className="text-lg font-bold tracking-tight">Peer to Peer</h1>
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#94A3B8]">private room</p>
            </div>
          </div>
        </header>
